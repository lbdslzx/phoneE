...
<table id="dg"  style="width:100%; "  title="查询结果"
    ...
    <thead>
    <tr>
        <?php if(is_array($table_title)): $i = 0; $__LIST__ = $table_title;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><th data-options="field:'<?php echo ($key); ?>',align:'center',width:'50px'"><?php echo ($vo); ?></th><?php endforeach; endif; else: echo "" ;endif; ?>
    </tr>
    </thead>
</table>
...
<script>
    $(function(){
        ...
        $("#submit_search").click();
//	$('#container').highcharts(<?php echo ($json); ?>);
    })
