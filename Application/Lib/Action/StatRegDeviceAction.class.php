...
/**
 * @example      客户端注册统计
 * @file         StatRegDeviceAction.class.php
 ...
 */
class StatRegDeviceAction extends CommonAction{
    private $_timeFor,$_timeTo,$_province,$_tableName='t_stat_daily_reg_report',$_dbName=DB_STAT;
    ...
    public function getList(){
        ...
        $list = $table->where($where)
            ...
            ->order("stat_dt DESC")
            ->select();
        $this->ajaxReturn(['total'=>count($list),'rows'=>$list]);
    }
    ...
    public function indexNew(){
        ...
        $this->assign("timeFor",$this->_timeFor);
        $this->assign("timeTo",$this->_timeTo);
        $this->display("stat_reg_device_list");
    }
