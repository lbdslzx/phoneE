...
class BugsIosManageAction extends CommonAction {

	public $table_name = "t_log_ios_bugs";
	public $db_name = DB_BUG;
	public $primary_key = "report_id"; //主键
...
// 		}
	...
	public function getList(){
		...
		foreach ($data as $k=>$v){
			...
			$data[$k]["action"] = '<a href="javascript:void(0);" onclick="view('.$data[$k][$this->primary_key].');" class="easyui-linkbutton" iconCls="icon-cancel" plain="true">查看详细</a>';
// 			$data[$k]["action"] = '
